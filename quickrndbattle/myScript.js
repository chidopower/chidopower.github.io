...
function start(){
   ...
   redPkm.isThePlayer=parseInt(document.getElementById("redPkmPlayer1or2").value);
   ...
   bluePkm.isThePlayer=parseInt(document.getElementById("bluePkmPlayer1or2").value);
   ...
   console.log("debug: ",redPkm.isThePlayer,bluePkm.isThePlayer);

   if(redPkm.isThePlayer===bluePkm.isThePlayer){
   		document.getElementById("infoAttack").innerHTML = "Error!!! :V ";
   		console.log("Error! player1 = player2");
   }else{
	   if(redPkm.isThePlayer===1){
	   		player1=redPkm.name;
	   		player2=bluePkm.name;
	   		console.log("player1 ",player1, redPkm.name);
	   		console.log("player2 ",player2, bluePkm.name);
	   	}else{
	   		player1=bluePkm.name;
	   		player2=redPkm.name;
	   		console.log("player1 ",player1, bluePkm.name);
	   		console.log("player2 ",player2, redPkm.name);   		
	   	}
...
function showInfo(){
   ...
   if(step%2===0){
      document.getElementById("infoNext").innerHTML = "Next: "+player2+".";
   }else{
      document.getElementById("infoNext").innerHTML = "Next: "+player1+".";
   }
