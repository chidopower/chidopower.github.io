...
var a, b, c, d // coeficientes
var PMA, PMB, PMC, PMD // pesos molares
var reaction; // string, reaccion quimica
var CA, CB, CC, CD; //compuestos
var uni; //unidades, g, mol
...
var counter=1;
var maxcounter=25; //25 preguntas en 1500 seg (20 min)
var maxtimeleft = 1500;
...
function play(){
	...
	//if(actividad==="actividad_14") play_act_11();
	//if(actividad==="actividad_12") play_act_12();
	if(actividad==="actividad_14") play_act_14();
 ...
 * */
	...
	let opt = rndi(1,4);
	let opt2 = rndi(1,6);
	let molesA = rndi(2,20);
	let gramosA = rndi(2,20)*10;
	...
	if(opt===3){ //C6H12O6 + 6 O2 -> 6 CO2 + 6 H2O
		...
		b = 6; CB = "O<sub>2</sub>"; PMB = 6*16;
		c = 6; CC = "CO<sub>2</sub>"; PMC = 12.01 + 2*16;
		d = 6; CD = "H<sub>2</sub>O"; PMD = 2*1.01 + 16;
	}
	if(opt===4){ //2 CH3OH + 3 O2 -> 2 CO2 + 4 H2O
		a = 2; CA = "CH<sub>3</sub>OH"; PMA = 12.01 + 4*1.01 + 16;
		b = 3; CB = "O<sub>2</sub>"; PMB = 6*16;
		c = 2; CC = "CO<sub>2</sub>"; PMC = 12.01 + 2*16;
		d = 4; CD = "H<sub>2</sub>O"; PMD = 2*1.01 + 16;
	}
	
	if(opt2===1){
		QUESTION  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QUESTION += "Se queman "+molesA+" mol de "+CA+".<br>";
		QUESTION += "¿Cuántos moles de "+CB+" se necesitan?<br>";
		
		let molesB = molesA * b/a; uni="mol";
		ANSWER = molesB;	
	}
	if(opt2===2){
		QUESTION  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QUESTION += "Se queman "+molesA+" mol de "+CA+".<br>";
		QUESTION += "¿Cuántos moles de "+CC+" se producen?<br>";
		
		let molesC = molesA * c/a; uni="mol";
		ANSWER = molesC;	
	}
	if(opt2===3){
		QUESTION  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QUESTION += "Se queman "+molesA+" mol de "+CA+".<br>";
		QUESTION += "¿Cuántos moles de "+CD+" se producen?<br>";
		
		let molesC = molesA * d/a; uni="mol";
		ANSWER = molesC;	
	}
	if(opt2===4){
		QUESTION  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QUESTION += "Se queman "+gramosA+" gramos de "+CA+".<br>";
		QUESTION += "¿Cuántos gramos de "+CB+" se necesitan?<br>";
		
		let molesA = gramosA/PMA;
		let molesB = molesA*b/a;
		let gramosB = molesB*PMB;
		ANSWER = gramosB;	
	}
	if(opt2===5){
		QUESTION  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QUESTION += "Se queman "+gramosA+" gramos de "+CA+".<br>";
		QUESTION += "¿Cuántos gramos de "+CC+" se producen?<br>";
		
		let molesA = gramosA/PMA;
		let molesC = molesA*c/a;
		let gramosC = molesC*PMC;
		ANSWER = gramosC;
	}
	if(opt2===6){
		QUESTION  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QUESTION += "Se queman "+gramosA+" gramos de "+CA+".<br>";
		QUESTION += "¿Cuántos gramos de "+CD+" se producen?<br>";
		
		let molesA = gramosA/PMA;
		let molesD = molesA*d/a;
		let gramosD = molesD*PMD;
		ANSWER = gramosD;
	}
