...
function startButton(){
	...
	console.log("startButton()", selQuiz[iSelQuiz], selLevel[iSelLevel]);
...
function playARITMETICA(){
	...
	if(selQuiz[iSelQuiz] === "SUMAR" && selLevel[iSelLevel] === "FACIL")
		sumaFacil3();
	else
		console.log("vergas");
	...
	var rightAns = intRand(1,6);

	if(rightAns === 1){
		if(DEBUG==="YES") console.log("ANS:",ANS);
		document.getElementById("ansButton1").innerHTML = ANS;
		document.getElementById("ansButton2").innerHTML = ANS + fake[0];
		document.getElementById("ansButton3").innerHTML = ANS + fake[1];
		document.getElementById("ansButton4").innerHTML = ANS + fake[2];
		document.getElementById("ansButton5").innerHTML = ANS + fake[3];
		document.getElementById("ansButton6").innerHTML = "NINGUNA";
	}

	if(rightAns === 2){
		if(DEBUG==="YES") console.log("ANS:",ANS);
		document.getElementById("ansButton1").innerHTML = ANS + fake[0];
	...
	if(rightAns === 3){
		if(DEBUG==="YES") console.log("ANS:",ANS);
		document.getElementById("ansButton1").innerHTML = ANS + fake[0];
		document.getElementById("ansButton2").innerHTML = ANS + fake[1];
	...
	if(rightAns === 4){
		...
		document.getElementById("ansButton1").innerHTML = ANS + fake[0];
		document.getElementById("ansButton2").innerHTML = ANS + fake[1];
		document.getElementById("ansButton3").innerHTML = ANS + fake[2];
	...
	if(rightAns === 5){
		...
		document.getElementById("ansButton2").innerHTML = ANS + fake[1];
		document.getElementById("ansButton3").innerHTML = ANS + fake[2];
		document.getElementById("ansButton4").innerHTML = ANS + fake[3];
		document.getElementById("ansButton5").innerHTML = ANS;
		document.getElementById("ansButton6").innerHTML = "NINGUNA";
	}

	if(rightAns === 6){
		if(DEBUG==="YES") console.log("ANS: NINGUNA");
		document.getElementById("ansButton1").innerHTML = ANS + fake[0];
		document.getElementById("ansButton2").innerHTML = ANS + fake[1];
		document.getElementById("ansButton3").innerHTML = ANS + fake[2];
		document.getElementById("ansButton4").innerHTML = ANS + fake[3];
		document.getElementById("ansButton5").innerHTML = ANS + fake[4];
		document.getElementById("ansButton6").innerHTML = "NINGUNA";
	}
}
