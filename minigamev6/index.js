...
function mousedown(e){
	...
	key_dt   	= Math.floor(key_time - key_oldtime);
	key_oldtime = key_time;
...
function state_welcome(){
	...
	ctx.fillText("M1N1G4M3d", window.innerWidth/2, window.innerHeight/2);
...
function mobs_spawn(){
	...
	mobs.push( new Mob(irand(1, N-1)*PIXEL, irand(1, N-N/2)*PIXEL, opt.mobsize, opt.mobsize) );
